...
const executableName = [process.env.OPENCODE_CLI_NAME, process.argv0, process.argv[1], process.execPath]
  .filter(Boolean)
  .join(" ")
  .toLowerCase()
const cliName = executableName.includes("opencodex") ? "opencodex" : "opencode"

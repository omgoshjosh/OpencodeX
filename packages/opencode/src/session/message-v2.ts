...
// time so a pre-compaction overflowing tail assistant doesn't get mistaken
// for the most recent turn. Message IDs wrap and cannot order long-lived
// sessions. tasks are
// compaction/subtask parts attached to user messages newer than the latest
// finished assistant — i.e. unprocessed work.
export function isAfter(a: Info, b: Info) {
